...
> ⚠️ Your alarm code is a **secret**. If you publish or share your config, make sure these are blanked (`****`) or moved into `secrets.yaml` — never commit your real code. See the secrets section.
